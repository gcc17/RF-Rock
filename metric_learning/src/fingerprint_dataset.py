...
class Dataset(DatasetFolder):
    def __init__(self, images_dir: str, transform=None, loader=None, extensions=None):
        if loader and extensions:
            super().__init__(images_dir, transform=transform, loader=loader, extensions=extensions)
        else:
